...
const DESC = "שיעורי נהיגה לאופנוע באשקלון – דרגות A, A1, A2 ידני ואוטומט. מורה צעיר, ציוד חדש, הכנה לטסט וליווי עד ההצלחה. שירות גם באשדוד, קריית גת ובדרום.";
  ...
  return (
    <SeoLanding
      ...
      highlights={[
        ...
        { icon: "trophy", title: "98% טסט ראשון", body: "תלמידי אופנוע מאשקלון, אשדוד וקריית גת עוברים ברובם בפעם הראשונה." },
