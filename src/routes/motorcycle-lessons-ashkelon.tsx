...
const faqs: SeoFaq[] = [
  { q: "מהן דרגות האופנוע ומה ההבדל?", a: "A2 – מגיל 16, עד 14.7 כ\"ס (ידני או אוטומט). A1 – מגיל 18, עד 47 כ\"ס (ידני או אוטומט). A – מגיל 21, ללא הגבלה (ידני בלבד)." },
  { q: "כמה שיעורי אופנוע צריך עד הטסט?", a: "תלוי בדרגה: A2 – מינימום 15 שיעורים. A1 – מינימום 15 שיעורים. מחזיקי A2 עם ותק שנה – 8 שיעורים בלבד. A – מינימום 8 שיעורים (מותנה ברישיון A1 עם ותק שנה)." },
  ...
  return (
    <SeoLanding
      ...
      highlights={[
        ...
        { icon: "trophy", title: "95% טסט ראשון", body: "תלמידי אופנוע מאשקלון והסביבה עוברים ברובם בפעם הראשונה." },
      ...
      licenseTiers={[
        {
          code: "A",
          title: "רישיון אופנוע A – ללא הגבלה",
          image: bikeA,
        ...
        {
          code: "A1",
          title: "רישיון אופנוע A1 – עד 47 כ״ס",
          image: bikeA1,
        ...
        {
          code: "A2",
          title: "רישיון אופנוע A2 – עד 14.7 כ״ס",
          image: bikeA2,
