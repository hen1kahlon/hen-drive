      ...
      licenseTiers={[
        {
          ...
          image: bikeA,
          body: "מגיל 21, ללא הגבלת נפח — הדרגה הגבוהה ביותר. מותנה ברישיון A1 עם ותק של שנה לפחות. מינימום 8 שיעורים.",
        ...
        },
        {
          ...
          image: bikeA1,
          body: "מגיל 18, אופנוע עד 47 כ\"ס. מינימום 15 שיעורים — או 8 שיעורים בלבד למחזיקי A2 עם ותק שנה לפחות.",
        ...
        },
        {
          ...
          image: bikeA2,
          body: "מגיל 16, רישיון אופנוע ראשון — עד 14.7 כ\"ס. מגיל 16–17 נדרש אישור הורים בכתב. מינימום 15 שיעורים. בעלי ותק 3 שנים על רכב פטורים ממסלול בטסט.",
          transmission: "ידני או אוטומט – לבחירתכם",
