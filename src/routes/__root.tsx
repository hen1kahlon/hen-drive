...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => {
    ...
    const meta: Array<Record<string, string>> = [
      ...
      { property: "og:title", content: "חן כחלון | מורה נהיגה באשקלון – לימוד נהיגה רכב ואופנוע" },
      { property: "og:description", content: "מורה נהיגה באשקלון לרכב אוטומט ואופנוע (A/A1/A2). שיעורי נהיגה מקצועיים, אווירה צעירה, ליווי אישי עד הטסט. התקשרו: 050-3250150" },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "he_IL" },
      { property: "og:site_name", content: "חן כחלון – מורה נהיגה" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "חן כחלון | מורה נהיגה באשקלון – לימוד נהיגה רכב ואופנוע" },
      { name: "twitter:description", content: "מורה נהיגה באשקלון לרכב אוטומט ואופנוע (A/A1/A2). שיעורי נהיגה מקצועיים, אווירה צעירה, ליווי אישי עד הטסט. התקשרו: 050-3250150" },
