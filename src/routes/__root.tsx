...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => {
    ...
    const meta: Array<Record<string, string>> = [
      ...
      { property: "og:description", content: "מורה נהיגה מקצועי באשקלון לרכב אוטומט ואופנוע. 98% הצלחה בטסט, 350+ תלמידים, ליווי אישי עד ההצלחה." },
      ...
      { name: "twitter:description", content: "מורה נהיגה מקצועי באשקלון לרכב אוטומט ואופנוע. 98% הצלחה בטסט, ליווי אישי עד ההצלחה." },
