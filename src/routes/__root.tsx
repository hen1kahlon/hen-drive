...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => {
    ...
    const meta: Array<Record<string, string>> = [
      ...
      { name: "description", content: "בית הספר לנהיגה של חן כחלון באשקלון והסביבה – מורה נהיגה לאופנוע (A / A1 / A2) ולרכב אוטומט. הכנה לטסט וליווי אישי עד ההצלחה. חייגו 050-3250150" },
      { name: "keywords", content: "מורה נהיגה אשקלון, מורה נהיגה לאופנוע אשקלון, בית ספר לנהיגה אשקלון, בית ספר לנהיגה לאופנוע, מורה אופנוע אשקלון, לימוד נהיגה אופנוע אשקלון, מורה נהיגה רכב אשקלון, שיעורי נהיגה אשקלון, רישיון A אשקלון, רישיון A1 אשקלון, רישיון A2 אשקלון, חן כחלון" },
    ...
    const scripts: Array<Record<string, string>> = [
      {
        ...
        children: JSON.stringify({
          ...
          description: "בית הספר לנהיגה של חן כחלון באשקלון והסביבה – מורה נהיגה לאופנוע (A / A1 / A2) ולרכב אוטומט. הכנה לטסט וליווי אישי עד ההצלחה.",
          ...
          hasOfferCatalog: {
            ...
            name: "שיעורי נהיגה",
            itemListElement: [
              { "@type": "Offer", itemOffered: { "@type": "Service", name: "לימוד נהיגה אופנוע A", areaServed: "אשקלון והסביבה" } },
              { "@type": "Offer", itemOffered: { "@type": "Service", name: "לימוד נהיגה אופנוע A1 / A2 ידני ואוטומט", areaServed: "אשקלון והסביבה" } },
              { "@type": "Offer", itemOffered: { "@type": "Service", name: "שיעורי נהיגה רכב אוטומט (דרגה B)", areaServed: "אשקלון והסביבה" } },
              { "@type": "Offer", itemOffered: { "@type": "Service", name: "הכנה לטסט וטסט ראשון", areaServed: "אשקלון והסביבה" } },
            ],
          },
