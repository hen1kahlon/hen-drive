...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => {
    ...
    const meta: Array<Record<string, string>> = [
      ...
      { title: "מורה נהיגה אשקלון | אופנוע ורכב – בית הספר לנהיגה של חן כחלון" },
      { name: "description", content: "בית הספר לנהיגה של חן כחלון באשקלון – מורה נהיגה לאופנוע (A / A1 / A2) ולרכב אוטומט. שיעורים באשקלון, אשדוד, קריית גת והדרום, הכנה לטסט וליווי אישי עד ההצלחה. חייגו 050-3250150" },
      { name: "keywords", content: "מורה נהיגה אשקלון, מורה נהיגה לאופנוע אשקלון, בית ספר לנהיגה אשקלון, בית ספר לנהיגה לאופנוע, מורה אופנוע אשקלון, לימוד נהיגה אופנוע אשקלון, מורה נהיגה רכב אשקלון, מורה נהיגה אשדוד, מורה נהיגה קריית גת, מורה נהיגה גן יבנה, מורה נהיגה נתיבות, מורה נהיגה שדרות, מורה נהיגה קרית מלאכי, שיעורי נהיגה אשקלון, הכנה לטסט אשקלון, רישיון אופנוע אשקלון, חן כחלון" },
      ...
      { property: "og:title", content: "מורה נהיגה אשקלון | אופנוע ורכב – חן כחלון" },
      { property: "og:description", content: "בית הספר לנהיגה של חן כחלון באשקלון – לימוד אופנוע (A / A1 / A2) ורכב אוטומט, הכנה לטסט וליווי אישי עד ההצלחה." },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "he_IL" },
      { property: "og:site_name", content: "חן כחלון – מורה נהיגה" },
      { property: "og:url", content: "https://hendrive.co.il/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "מורה נהיגה אשקלון | אופנוע ורכב – חן כחלון" },
      { name: "twitter:description", content: "בית הספר לנהיגה של חן כחלון באשקלון – אופנוע ורכב, הכנה לטסט וליווי אישי עד ההצלחה." },
    ...
    const scripts: Array<Record<string, string>> = [
      {
        ...
        children: JSON.stringify({
          ...
          alternateName: "Hen Kahlon Driving School - Ashkelon",
          description: "בית הספר לנהיגה של חן כחלון באשקלון – מורה נהיגה לאופנוע (A / A1 / A2) ולרכב אוטומט. שירות באשקלון, אשדוד, קריית גת ובאזור הדרום. הכנה לטסט וליווי אישי עד ההצלחה.",
          ...
          hasOfferCatalog: {
            ...
            name: "שיעורי נהיגה",
            itemListElement: [
              { "@type": "Offer", itemOffered: { "@type": "Service", name: "לימוד נהיגה אופנוע A", areaServed: ["אשקלון", "אשדוד", "קריית גת", "גן יבנה", "קרית מלאכי", "נתיבות", "שדרות"] } },
              { "@type": "Offer", itemOffered: { "@type": "Service", name: "לימוד נהיגה אופנוע A1 / A2 ידני ואוטומט", areaServed: ["אשקלון", "אשדוד", "קריית גת", "גן יבנה", "קרית מלאכי", "נתיבות", "שדרות"] } },
              { "@type": "Offer", itemOffered: { "@type": "Service", name: "שיעורי נהיגה רכב אוטומט (דרגה B)", areaServed: ["אשקלון", "אשדוד", "קריית גת", "גן יבנה", "קרית מלאכי"] } },
              { "@type": "Offer", itemOffered: { "@type": "Service", name: "הכנה לטסט וטסט ראשון", areaServed: ["אשקלון", "אשדוד", "קריית גת", "גן יבנה", "קרית מלאכי", "נתיבות", "שדרות"] } },
            ],
          },
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Person",
          name: "חן כחלון",
          jobTitle: "מורה נהיגה לאופנוע ורכב – אשקלון",
          worksFor: { "@id": "https://hendrive.co.il/#business" },
          telephone: "+972503250150",
          areaServed: ["אשקלון", "אשדוד", "קריית גת", "גן יבנה", "קרית מלאכי", "נתיבות", "שדרות"],
        }),
      },
      {
        type: "application/ld+json",
