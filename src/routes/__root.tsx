...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => {
    ...
    const meta: Array<Record<string, string>> = [
      ...
      { property: "og:title", content: "מורה נהיגה אשקלון | חן כחלון — רכב ואופנוע" },
      { property: "og:description", content: "מורה נהיגה מקצועי באשקלון לרכב אוטומט ואופנוע. 95% הצלחה בטסט, 350+ תלמידים, ליווי אישי עד ההצלחה." },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "he_IL" },
      { property: "og:site_name", content: "חן כחלון – מורה נהיגה" },
      { property: "og:url", content: "https://hendrive.co.il/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "מורה נהיגה אשקלון | חן כחלון — רכב ואופנוע" },
      { name: "twitter:description", content: "מורה נהיגה מקצועי באשקלון לרכב אוטומט ואופנוע. 95% הצלחה בטסט, ליווי אישי עד ההצלחה." },
