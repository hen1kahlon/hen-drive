  ...
  return (
    <>
      ...
      <button
        ...
        aria-expanded={open}
        className="fixed bottom-24 md:bottom-6 right-4 z-[60] h-14 w-14 rounded-full bg-[oklch(0.55_0.22_255)] hover:bg-[oklch(0.62_0.22_255)] text-white shadow-glow flex items-center justify-center border-2 border-white/20 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-white/40 transition-colors"
      >
      ...
      {open && (
        <div
          ...
          className="fixed bottom-44 md:bottom-24 right-4 z-[60] w-72 glass-strong border border-white/10 rounded-2xl p-4 shadow-card text-foreground"
        >
