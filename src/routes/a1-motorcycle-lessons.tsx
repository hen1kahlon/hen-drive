  ...
  return (
    <SeoLanding
      ...
      highlights={[
        ...
        { icon: "car", title: "שירות בכל הדרום", body: "אשקלון, אשדוד, קריית גת, נתיבות ושדרות." },
      ]}
      reviews={[
        { name: "עומר כ׳ – אשקלון", type: "אופנוע A1", text: "שיעורים ממוקדים, הכנה אמיתית לטסט. רישיון ביד!" },
        { name: "תום ר׳ – אשדוד", type: "אופנוע A1", text: "אופנוע חדש, מורה רגוע ואחרי שלושה שבועות עברתי." },
        { name: "אורי ב׳ – קריית גת", type: "אופנוע A1", text: "המעבר מאוטומט לידני היה חלק, הסברים מעולים." },
      ]}
      faqs={faqs}
      related={[
